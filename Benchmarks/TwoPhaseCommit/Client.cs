...
public class Client : Actor
{
    public class SetupEvent : Event
    {
        ...
        public SetupEvent(ActorId coordinator, int numRequests, TimeSpan retryTimeout)
        {
    ...
    {
        this.SendEvent(this.ClientInfo.Coordinator, new ClientRequestEvent(this.Id, this.NextCommand));
